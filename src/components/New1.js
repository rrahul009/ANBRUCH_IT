...
export default function New1() {
    return (
        <div className="  flex flex-col items-center p-4 bg-gray-100" data-aos="fade-up" >
            <Head>
            ...
            <main className="w-full max-w-9xl mx-auto mt-10 text-center"style={{height:'400px'}}>
                {/* Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="relative bg-gray-200 rounded-lg overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white text-lg font-bold p-6">
                    ...
                    <div className="relative bg-gray-200 rounded-lg overflow-hidden">
                        ...
                        />  
                        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white text-lg font-bold p-6">
                            <span className="text-4xl font-bold">25,0   0</span>
