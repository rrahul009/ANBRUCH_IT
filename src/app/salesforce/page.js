  ...
  <div className="container mx-auto px-6 text-center">
    ...
    <p className="text-lg md:text-md text-white opacity-90">
      Explore our range of Salesforce services designed to optimize your CRM and enhance business efficiency.
        ...
        {/* <section className="bg-gradient-to-r from-purple-400 to-indigo-600 text-white py-2 mt-5">
        <div className="container mx-auto px-6 text-center">
  <Link 
    href="/contact" 
    className="bg-white text-black hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out inline-flex items-center justify-center"
  >
 ...
 <section className="bg-white p-8 mb-16 rounded-lg shadow-md">
  ...
  <div className="space-y-8">
    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        <p className="text-gray-700 mb-2">
          "The Salesforce integration service was exceptional. The team seamlessly connected our Salesforce system with other platforms, which enhanced our workflow efficiency and data accuracy."
        </p>
    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        <p className="text-gray-700 mb-2">
          "Their expertise in Salesforce optimization has been invaluable. We now have a more streamlined CRM system, which has significantly improved our customer service and sales tracking."
        </p>
...
// const ServiceCard = ({ title, description, img, duration, price, benefits, targetAudience, ctaLink }) => (
//   <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-6">
...
//       <img src={img} alt={`${title} image`} className="w-full h-auto object-cover rounded-lg" />
//     </div>
//   </div>
// );
...
//       <Navbar />
//       <main className="container mx-auto p-6">
//         <h1 className="text-3xl font-bold mb-8 text-center">Our Salesforce Services</h1>
